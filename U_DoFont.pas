...
//      blockwrite(f,ArrayPoint[i],sizeof(integer));
  ...
  FormFont.Caption := 'Font Maker ][ '+chr(169)+'NYCD 2004';
...
begin                                               // affichage de la grille
  ...
  BevelImgBox.Width := largeur*nbcol+16;             // on ajuste le bevel autour
  BevelImgBox.Height := ImgBox.Picture.Graphic.Height+15;
